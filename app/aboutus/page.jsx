  ...
  return (
    <>
      <Head>
        ...
        {/* ✅ Structured Data: JSON-LD for SEO with founder info */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Organization",
              name: "Newwss",
              url: "https://www.newwss.com",
              founder: {
                "@type": "Person",
                name: "DHARANEESH R",
              },
              sameAs: ["https://www.linkedin.com/in/dharaneeshr"],
            }),
          }}
        />
      </Head>
        ...
        <div className="relative overflow-hidden bg-[#111829] text-white">
          ...
          <div className="relative px-4 py-20 max-w-6xl mx-auto text-center h-screen">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              ...
              <span className="text-pink-300 font-bold"> fearless</span>{" "}
              journalism that empowers your decisions
            </p>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              {["📈 Business", "💰 Finance", "🚀 Tech"].map((item, index) => (
                <div
                  key={index}
                  className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 hover:bg-white/20 transition-all duration-300"
                >
            ...
            <div className="group">
              <div className="h-full p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-indigo-200 hover:-translate-y-2">
                ...
                <p className="text-gray-600 text-lg leading-relaxed">
                  Empower readers with timely and accurate news that drives
                  awareness, informed decisions, and positive impact across
            ...
            <div className="p-8 bg-gradient-to-r from-green-50 to-emerald-50 rounded-3xl border-2 border-green-100">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  {
                    icon: "📱",
                    text: "Mobile-optimized, ad-light reading experience",
                  },
                  {
                    icon: "⚡",
                    text: "Modern tech stack (Next.js, Node.js, MongoDB)",
                  },
                  {
                    icon: "🌐",
                    text: "Real-time updates with credible sources",
                  },
                ].map((item, index) => (
                  <div
                    key={index}
                  ...
                  {[
                    {
                      ...
                      platform: "Twitter (X)",
                      handle: "@newwss",
                      url: "https://x.com/newwss",
                    },
                    {
                      icon: "📸",
                      platform: "Instagram",
                      handle: "@newwss",
                      url: "https://instagram.com/newwss",
                    },
                    {
                      icon: "📺",
                      platform: "YouTube",
                      handle: "@newwss",
                      url: "https://youtube.com/@newwss",
                    },
                  ].map((social, index) => (
                    <div
                      key={index}
                      className="flex items-center p-3 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:scale-105"
                    >
